...
public class ViewLibrarian extends javax.swing.JFrame {
    ...
    public void getLibrarians()
    {
        ...
        Query query = hibconf.session.createQuery("from Librarian");
        DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
        List<Librarian> librarian = query.list();
        Object rowData[] = new Object[3];
        for(int i=0; i<librarian.size();i++)
        {
            rowData[0] = librarian.get(i).getId();
            rowData[1] = librarian.get(i).getName();
            rowData[2] = librarian.get(i).getEmail();
